...
<form id="myform" action="{{ route('akun.update', $akun->id) }}" method="POST" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group my-3">
                        ...
                        <small>*lewati jika tidak ingin mengubahnya</small>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_depan"
                                    value="{{ old('nama_depan', $akun->nama_depan) }}">
                                @error('nama_depan')
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_belakang"
                                    value="{{ old('nama_belakang', $akun->nama_belakang) }}">
                                @error('nama_belakang')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class=" mb-3">
                        <label class="form-label @error('nik') is-invalid @enderror">Nomor Induk Kependudukan /
                            NIK</label>
                        <input type="text" class="form-control" name="nik" value="{{ old('nik', $akun->nik) }}">
                        @error('nik')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class=" mb-3">
                        ...
                        <textarea class="form-control" rows="3"
                            name="alamat">{{ old('alamat', $akun->alamat) }}</textarea>
                        @error('alamat')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="rt" value="{{ old('rt', $akun->rt) }}">
                                @error('rt')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="rw" value="{{ old('rw', $akun->rw) }}">
                                @error('rw')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="kelurahan"
                            value="{{ old('kelurahan', $akun->kelurahan) }}">
                        @error('kelurahan')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="kecamatan"
                            value="{{ old('kecamatan', $akun->kecamatan) }}">
                        @error('kecamatan')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="is_admin">
                            <option value="0" {{ !$akun->is_admin ? 'selected' : '' }}>RW</option>
                            <option value="1" {{ $akun->is_admin ? 'selected' : '' }}>Admin</option>
                        </select>
                    </div>
                </div>
            </div>
